...
const programs = [
  {
    ...
    location: "HarounKuti Main Pitch",
    status: "Open",
  ...
  },
  {
    ...
    name: "Senior Squad",
    age: "18 & above",
    desc: "Our competitive senior team trains hard and represents HarounKuti FC in tournaments across the region all year round.",
...
export default function ProgramSection() {
  return (
    <section
      id="programs"
      className="pt-35 px-6 max-w-7xl mx-auto relative z-10"
    >
      <Image
        src={kicking}
        alt="Kicking a ball"
        className="md:max-w-125 md:max-h-100 max-w-75 max-h-87.5 absolute h-full md:left-0 -z-1 -top-20 md:-top-5 rotate-2 opacity-20 "
      />
