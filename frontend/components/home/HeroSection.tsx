...
export default function HeroSection() {
  return (
    <section className="relative pt-10 bg-black/80 flex items-center overflow-hidden h-100 md:h-125 lg:h-190"
    ...
    >
      ...
      <div className="relative flex flex-col px-8 md:px-12 py-14 gap-5 text-center items-center mx-auto z-10">
        <h1 className="font-black text-4xl md:text-5xl text-white leading-[1.1] mb-5">
          Where passion meets <br />the{" "} 
          <span className="text-logo-green uppercase">beautiful game</span>
        </h1>
